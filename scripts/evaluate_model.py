...
def main() -> None:
    ...
    # Load the transcription pipeline once to reuse across all samples
    # This significantly improves evaluation speed by avoiding reloading the model for each file
